...
document.getElementById("puzzle").innerHTML =
   ...
   function setupPuzzle() {
      ...
      for (var i = 0; i < allCells.length; i++) {
         ...
         allCells[i].addEventListener("mousedown", setBackground);
   ...
   function setBackground(e) {
      ...
      for (var i = 0; i < allCells.length; i++) {
         ...
         e.target.style.cursor = "url(./photos/jpf_eraser.png), alias";
         }
       else if (e.altKey) {
         e.target.style.backgroundColor = "black";
         e.target.style.color = "white";
         e.target.style.borderRadius = "0";
         e.target.style.cursor = "url(./photos/jpf_block.png), cell";
      } else {
         e.target.style.backgroundColor = "rgb(101, 101, 101)";
         e.target.style.color = "white";
         e.target.style.borderRadius = "50%";
         e.target.style.cursor = "url(./photos/jpf_circle.png), pointer";
      }
      }
      e.preventDefault();
   }
